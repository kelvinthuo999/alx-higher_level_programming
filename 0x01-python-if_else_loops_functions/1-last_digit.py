...
if last_digit > 5:
    ...
    print(f"Last digit of {number}, followed by")
    print(f"the number, followed by")
    print(f"the string is {last_digit} and is greater than 5")
    # Print the appropriate message if the last digit is greater than 5
elif last_digit == 0:
    # Check if the last digit is 0
    print(f"Last digit of {number}, followed by")
    print(f"the number, followed by")
    print(f"the string is 0 and is 0")
    ...
    print(f"Last digit of {number}, followed by")
    print(f"the number, followed by")
    print(f"the string is {last_digit} and is less than 6 and not 0")
